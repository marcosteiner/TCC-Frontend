...
describe('Test the consumptionDataInitializer', () => {
    ...
    it('returns an array of coffee objects with provided consumption data', () => {
        let result = converter.consumptionDataFactory(coffees, [{"coffee_name":"Milchkaffee","person_name":"Marco","coffee_count":27},{"coffee_name":"Espresso","person_name":"Marco","coffee_count":2}]);
